...
First of all, we refined the different refined the different software requirements we specified in our SRS. Building on this we defined many possible Use-Cases and reduced them to a dozen. These dozen use-cases were analyzed based on their complexity and their dependencies to other tasks and were then split up between the scope of the ongoing and the coming semester.
